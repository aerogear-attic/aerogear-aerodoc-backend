...
/**
 * The pupose of this class is to offer CORS support. All the OPTIONS
 * requests, no matter the path, will be handled in this class. It also offers
 * convenient method to append the allow origin header to any request.
 * Any Endpoint class that would like CORS support should extends this class.
 */
@Path("{path : .*}")
